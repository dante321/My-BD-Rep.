...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."AFICION"."AFICION_ID" IS 'IDENTIFICADOR';
   COMMENT ON COLUMN "HR"."AFICION"."EQUIPO_ID" IS 'EQUIPO_FK';
   COMMENT ON COLUMN "HR"."AFICION"."NOMBRE" IS 'NOMBRE DE GUERRA';
   COMMENT ON COLUMN "HR"."AFICION"."CANTICO_ID" IS 'CANTICO_FK';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."CANTICO"."CANTICO_ID" IS 'IDENTIFICADOR PRIMARIO';
   COMMENT ON COLUMN "HR"."CANTICO"."AFICION_ID" IS 'AFICION_FK';
   COMMENT ON COLUMN "HR"."CANTICO"."CANTICO" IS 'CONTICO COMPLETO';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."EQUIPO"."EQUIPO_ID" IS 'IDENTIFICADOR';
   COMMENT ON COLUMN "HR"."EQUIPO"."NOMBRE" IS 'NOMBRE DE EQUIPO';
   COMMENT ON COLUMN "HR"."EQUIPO"."FECHA_FUNDACION" IS 'FECHA';
   COMMENT ON COLUMN "HR"."EQUIPO"."AFICION_ID" IS 'POSIBLE AFICION_ID';
   COMMENT ON COLUMN "HR"."EQUIPO"."ESTADIO_ID" IS 'ESTADIO DE EQUIPO';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."ESTADIO"."ESTADIO_ID" IS 'IDENTIFICADOR DE ESTADIO';
   COMMENT ON COLUMN "HR"."ESTADIO"."NOMBRE" IS 'NOMBRE DE IDENTIFICACION';
   COMMENT ON COLUMN "HR"."ESTADIO"."EQUIPO_ID" IS 'EQUIPO_FK';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."JUGADORES"."JUGADORES_ID" IS 'IDENTIFICADOR DE JUGADORES';
   COMMENT ON COLUMN "HR"."JUGADORES"."NOMBRE" IS 'NOMBRE DE JUGADOR';
   COMMENT ON COLUMN "HR"."JUGADORES"."EQUIPO_ID" IS 'EQUIPO_FK';
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into HR.AFICION (AFICION_ID,EQUIPO_ID,NOMBRE,CANTICO_ID) values ('2','2','ATLETICOS','2');
Insert into HR.AFICION (AFICION_ID,EQUIPO_ID,NOMBRE,CANTICO_ID) values ('1','1','MADRIDISTAS','1');
REM INSERTING into HR.CANTICO
SET DEFINE OFF;
Insert into HR.CANTICO (CANTICO_ID,AFICION_ID,CANTICO) values ('1','1','HALA MADRID! HALA MADRID!');
Insert into HR.CANTICO (CANTICO_ID,AFICION_ID,CANTICO) values ('2','2','ATLETI! ATLETI!');
...
SET DEFINE OFF;
Insert into HR.EQUIPO (EQUIPO_ID,NOMBRE,FECHA_FUNDACION,AFICION_ID,ESTADIO_ID) values ('1','REAL MADRID',to_date('22/05/03','DD/MM/RR'),'1','1');
Insert into HR.EQUIPO (EQUIPO_ID,NOMBRE,FECHA_FUNDACION,AFICION_ID,ESTADIO_ID) values ('2','ATLETICO DE MADRID',to_date('17/06/10','DD/MM/RR'),'2','2');
Insert into HR.EQUIPO (EQUIPO_ID,NOMBRE,FECHA_FUNDACION,AFICION_ID,ESTADIO_ID) values ('3','GETAFE',to_date('24/07/30','DD/MM/RR'),null,null);
REM INSERTING into HR.ESTADIO
SET DEFINE OFF;
Insert into HR.ESTADIO (ESTADIO_ID,NOMBRE,EQUIPO_ID) values ('1','SANTIAGO','1');
Insert into HR.ESTADIO (ESTADIO_ID,NOMBRE,EQUIPO_ID) values ('2','CALDERON','2');
Insert into HR.ESTADIO (ESTADIO_ID,NOMBRE,EQUIPO_ID) values ('3','CANALETAS','3');
...
SET DEFINE OFF;
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE,EQUIPO_ID) values ('1','PEPE','1');
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE,EQUIPO_ID) values ('2','KOKE','2');
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE,EQUIPO_ID) values ('3','MODRIC','1');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HR"."LIGA_PK" ON "HR"."EQUIPO" ("EQUIPO_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HR"."CANTICO_PK" ON "HR"."CANTICO" ("CANTICO_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."EQUIPO" MODIFY ("FECHA_FUNDACION" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."CANTICO" MODIFY ("CANTICO" NOT NULL ENABLE);
  ALTER TABLE "HR"."CANTICO" ADD CONSTRAINT "CANTICO_PK" PRIMARY KEY ("CANTICO_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."CANTICO" ADD CONSTRAINT "AFICION_FK" FOREIGN KEY ("AFICION_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."JUGADORES" ADD CONSTRAINT "EQUIPO_FK2" FOREIGN KEY ("EQUIPO_ID")
	  REFERENCES "HR"."EQUIPO" ("EQUIPO_ID") ENABLE;
--------------------------------------------------------
